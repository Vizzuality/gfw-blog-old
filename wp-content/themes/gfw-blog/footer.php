...
?>
  ...
  <footer id="footerView" class="layout-footer">
    <div class="apps-footer mobile-hide">
      <div class="inner">
        <ul>
          <li><a href="#"><svg class="world"><use xlink:href="#shape-world"></use></svg><h3 class="world">Explore the map</h3></a></li>
          <li><a href="#"><svg class="country"><use xlink:href="#shape-country"></use></svg><h3 class="country">Country profiles & rankings</h3></a></li>
          <li><a href="#"><svg class="fire"><use xlink:href="#shape-fire"></use></svg><h3 class="fire">Fires</h3></a></li>
          <li><a href="#"><svg class="commodities"><use xlink:href="#shape-commodities"></use></svg><h3 class="commodities">Commodities</h3></a></li>
          <li><a href="#"><svg class="develop"><use xlink:href="#shape-develop"></use></svg><h3 class="develop">Develop your app</h3></a></li>
          <li><a href="#"><svg class="soon"><use xlink:href="#shape-soon"></use></svg><h3 class="soon">Coming soon</h3></a></li>
        </ul>
      </div>      
    </div>
    <div class="site-map mobile-hide">
      <div class="inner">
        <div class="row">
          ...
          <div class="col">
            <h3><a href="#">KEEP UPDATED</a></h3>
            <ul>
              <li><a href="#">GFW Blog</a></li>
              <li><a href="#">Crowdsourced Stories</a></li>
              <li><a href="#">Receive Alerts</a></li>
          ...
          <div class="col">
            ...
            <ul>
              <li><a href="#">The GFW Partnership</a></li>
          ...
          <div class="col">
            ...
            <ul class="submenu">
              ...
              <li><a href="#">Terminology FAQS</a></li>
              <li><a href="#">Data FAQS</a></li>
              <li><a href="#">Web platform FAQS</a></li>
              <li><a href="#">GFW for businesses</a></li>
            </ul>          
          </div>       
        </div>
      </div>
    ...
    <div class="partner-box">
      <div class="inner">
        <h4>A partnership convened by</h4>
        <div class="row">
          <div class="wri-logo"></div>
          <p class="address">
            <strong>Global Forest Watch</strong>
            <span>10 G Street NE Suite 800, Washington, DC 20002, USA </span>
            <span>Phone +1 (202) 729-7600. Fax: +1 (202) 720 7610</span>
          </p>
        </div>
      </div>
    </div>
    <div class="footer-logos">
      <div class="inner">
        <div id="footer-logos">
          ...
          <div><a href="http://blueraster.com/" class="footer-logo blueraster" target="_blank"></a></div>
          <div><a href="http://www.regjeringen.no/en/dep/kld/kampanjer/the-governments-climate-and-tree-project.html?id=733947" class="footer-logo norwegian" target="_blank"></a></div>
          <div><a href="http://www.usaid.gov/" class="footer-logo usaid" target="_blank"></a></div>
          <div><a href="http://www.thegef.org/gef/" class="footer-logo gef" target="_blank"></a></div>
          <div><a href="http://www.gov.uk/government/organisations/department-for-international-development" class="footer-logo ukaid" target="_blank"></a></div>
          <div><a href="http://www.tiliafund.org/" class="footer-logo tilia" target="_blank"></a>      </div>
        </div>      
      </div>
    </div>
    <div class="terms">
      <a href="#">Terms of Service</a>
      <a href="#">Global Forest Watch System Status</a>
      <a href="#">Contact us</a>
    </div>  
  </footer>  
  ...
  <svg class="is-hidden" style="display:none">
      ...
      <symbol id="shape-commodities" viewBox="0 0 25 25">
        <path d="M 9 12 L 9 6 L 4.0951 6 L 2 10.7362 L 2 12.3678 L 2 14.1076 L 2 14.8813 L 1.303 16.0884 L 1 17 L 2.8126 17 C 2.8126 18.4816 3.605 19.9649 4.9428 19.9649 C 6.2807 19.9649 7.3653 18.4816 7.3653 17 L 16.7935 17 C 16.7935 18.4816 17.8781 19.9649 19.2159 19.9649 C 20.5538 19.9649 21.6385 18.4816 21.6385 17 L 24 17 L 24 12 L 9 12 ZM 4.2784 7 L 8 7 L 8 10 L 2.8673 10 L 4.2784 7 Z"/>
        <path d="M 22 9 L 10 9 L 10 11 L 22 11 L 22 9 Z"/>
      </symbol>
      <!-- Country -->
      <symbol id="shape-country" viewBox="0 0 25 25">
        <path d="M 21.5604 4.9287 C 21.5604 3.3138 20.2511 2 18.6417 2 C 17.0323 2 15.7231 3.3138 15.7231 4.9287 C 15.7231 6.4127 17.9526 10.5764 18.6411 11.5539 C 19.3611 10.5518 21.5604 6.3963 21.5604 4.9287 Z"/>
        <path d="M 2.0141 11.7165 C 2.0141 11.7165 2.4291 11.011 3.7812 10.3474 C 5.1334 9.6839 4.7827 9.3262 7.4869 9.9897 C 10.1911 10.6533 10.1268 11.7165 12.493 11.3847 C 14.8591 11.0529 14.8591 10.3894 15.5352 11.0529 C 16.2113 11.7165 16.7478 12.0223 16.8873 12.0482 C 17.0269 12.0742 17.6614 11.55 17.5634 11.7165 C 17.4653 11.883 18.6177 13.983 18.5775 13.8744 C 18.5372 13.7658 20.6057 10.7212 20.6057 10.7212 C 20.6057 10.7212 21.7184 11.1314 22.2958 11.0529 C 22.8732 10.9744 22.7174 10.1331 23.6479 10.7212 C 24.5784 11.3091 24.6481 11.6397 24.662 12.0482 C 24.6758 12.4568 25 13.0436 25 13.0436 C 25 13.0436 24.7089 14.1924 23.9859 13.7072 C 23.2629 13.2219 23.0278 12.6203 22.6338 13.3753 C 22.2399 14.1304 23.2106 14.7426 23.3098 15.0342 C 23.4091 15.3259 23.3201 15.448 22.6338 15.6978 C 21.9475 15.9475 21.4868 16.7634 21.6198 17.0249 C 21.7527 17.2864 20.8168 17.6483 20.9437 18.352 C 21.0706 19.0557 20.0673 20.6555 19.2535 21.338 C 18.4397 22.0204 18.4229 23.0647 18.5775 22.9969 C 18.7321 22.929 16.9366 20.446 17.2253 19.6791 C 17.514 18.9122 17.8563 18.6584 17.5634 18.0202 C 17.2704 17.382 16.8873 18.0202 16.8873 18.0202 C 16.8873 18.0202 14.4573 19.7588 14.1831 20.6744 C 13.9088 21.59 13.5984 18.1802 13.169 18.0202 C 12.7396 17.8602 12.3558 17.8094 11.8169 17.3567 C 11.278 16.9039 9.4507 17.3567 9.4507 17.3567 C 9.4507 17.3567 10.315 18.4016 8.7747 19.0155 C 7.2343 19.6295 6.0704 20.3426 6.0704 20.3426 C 6.0704 20.3426 4.4982 20.3385 4.3803 20.3426 C 4.2624 20.3467 5.7895 19.3337 5.7324 17.6884 C 5.6753 16.0432 4.6383 15.8365 4.7183 15.366 C 4.7983 14.8955 4.0422 13.7072 4.0422 13.7072 L 2.6902 13.0436 L 1 13.3753 L 2.0141 11.7165 Z"/>
      </symbol>
      <!-- Develop -->
      <symbol id="shape-develop" viewBox="0 0 25 25">
        <g>
          <path d="M 13.2204 16.4641 C 13.3931 16.6516 13.0252 17.3231 12.8785 17.5164 L 17.9667 22.7297 C 18.4057 23.1791 19.1195 23.1731 19.562 22.7172 L 21.1641 21.0658 C 21.6066 20.6098 21.6125 19.874 21.1763 19.4216 L 16.1024 14.1605 L 15.1013 15.2042 C 14.8212 15.4961 14.4401 15.6104 14.0876 15.5454 C 14.0876 15.5454 13.2648 16.3875 13.1831 16.4236 L 13.2204 16.4641 ZM 8.1833 12.7084 L 8.9826 13.5262 L 9.0353 13.4712 C 9.2188 13.2828 9.8982 12.9083 10.0814 13.1073 L 10.1974 13.2342 C 10.2334 13.149 10.9788 12.3464 10.9788 12.3464 C 10.8714 11.9392 10.9786 11.4769 11.2943 11.1531 L 12.2531 10.1686 L 11.4532 9.3381 C 11.3471 9.228 11.2255 9.144 11.0957 9.085 C 11.335 8.4846 11.4785 7.8316 11.5063 7.1447 C 11.638 3.886 9.122 1.1153 5.8938 1.0035 C 5.1565 0.9778 4.4489 1.0944 3.7959 1.3278 L 7.6174 5.1216 L 4.3725 8.5183 L 0.4395 4.5484 C 0.1652 5.2154 0.0101 5.9458 0.0005 6.7128 C -0.0394 9.9063 2.4572 12.5609 5.585 12.6872 C 6.4074 12.7204 7.1968 12.5765 7.916 12.2873 C 7.9733 12.441 8.0624 12.5845 8.1833 12.7084 Z"/>
          <path d="M 21.0269 1.805 L 11.9175 11.1531 C 11.6018 11.4769 11.4947 11.9392 11.6021 12.3464 L 10.5941 13.3828 C 10.5266 13.4522 10.4742 13.5323 10.4383 13.6174 L 10.3224 13.4906 C 10.1391 13.2916 9.842 13.2828 9.6585 13.4712 L 8.9926 14.1545 C 8.8084 14.3435 8.8073 14.6592 8.9906 14.8595 L 9.4855 15.4004 L 6.5746 18.3993 L 3.9555 19.766 L 2.7294 22.4347 L 4.116 24 L 6.6564 22.7876 L 8.0297 20.0109 L 10.9404 16.9902 L 11.4401 17.5362 C 11.6258 17.7392 11.9259 17.7479 12.1102 17.5558 L 12.7761 16.8618 C 12.9596 16.6705 12.9577 16.3521 12.7721 16.1504 L 12.7348 16.1099 C 12.8164 16.0738 12.8941 16.0214 12.9616 15.9512 L 14.0215 14.8485 C 14.3741 14.9133 14.7552 14.7992 15.0352 14.5073 L 24.143 5.0149 C 24.5765 4.563 24.5761 3.8373 24.1439 3.3937 L 22.586 1.7951 C 22.1577 1.3555 21.4605 1.36 21.0269 1.805 Z"/>
        </g>
      </symbol>
      <!-- Download -->
      <symbol id="shape-download" viewBox="0 0 25 25">
        <g opacity="0.502">
          <g>
            <path d="M 11.0536 5 L 11.0536 10.8968 L 8 10.8968 L 12.5 17 L 17 10.8968 L 13.9464 10.8968 L 13.9464 5 L 11.0536 5 Z"/>
          </g>
        </g>
        <path d="M 4 21 L 21 21 L 21 14 L 19 14 L 19 19 L 6 19 L 6 14 L 4 14 L 4 21 Z"/>
      </symbol>
      ...
      <symbol id="shape-house" viewBox="0 0 25 25">
        <path d="M 7 12 L 7 21 L 11 21 L 11 15 L 15 15 L 15 21 L 19 21 L 19 12 L 22 12 L 13 3 L 4 12 L 7 12 Z"/>
      </symbol>
